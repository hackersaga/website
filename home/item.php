...
?><html language="en">
	<head>
		...
		<script type="text/javascript">
			...
			var fshare = "http://www.facebook.com/sharer.php?s=100&p[url]=";
			...
			function loadNewData(){
				...
				$('<img src="../img/small/'+data.data[new_item_id]['pname']+'">').load(function(){
					...
					$("#share_facebook").attr('href',fshare+(window.location.href.replace('#','%23'))+"&p[images][0]=http://www.beyondpinkshop.com/img/small/"+data.data[new_item_id]['pname']+"&p[title]="+data.data[new_item_id]['title']+"&p[summary]="+data.data[new_item_id]['description']);
			...
			given_id = document.location.href.split("%23")[1];
                        if(given_id==undefined){given_id = document.location.href.split("#")[1];}
				bindSearchEvent();
							data1  = <?php 
	...
	<body>
		...
		<div id="container">
			...
			<div id="details">	
				...
				<div id="price_div">
					...
					<div>Rs. <span id="price"></span></div><br>
		...
		<div class="checkout">
			<a href="mycart.php">
				<img id="checkout" src="../img/item/cart3.png"/>
			</a>
		</div>
